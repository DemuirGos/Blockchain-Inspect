...
namespace NethereumSample
{
    class Program
    {
        ...
        static Web3? web3 = new Nethereum.Web3.Web3("[<Node Ip and Stuff>]");
        ...
        static async Task Main(string[] args)
        {
            ...
            var AnyEofsFound = await Task.WhenAll(Enumerable.Range(0, len)
                .Select(i => (i * batchSize, (i + 1) * batchSize))
                .Select((range) => IsThereAnyEofInBlock(range.Item1, range.Item2, StartWithEofPrefixTx)));
